    ...
    className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10'} max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen
         ...
         max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
            ...
            <a onClick={()=> setSidbarOpen(false)} href="#services" className='sm:hover:border-b'>Services</a>
            <a onClick={()=> setSidbarOpen(false)} href="#our-work" className='sm:hover:border-b'>Our Work</a>
            <a onClick={()=> setSidbarOpen(false)} href="#contact-us" className='sm:hover:border-b'>Contact Us</a>
        </div>
